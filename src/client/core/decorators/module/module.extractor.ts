...
export const AsyncModuleExtractor = (target: Object) => {
    return {
        ...
        services: (Reflect.getMetadata(MDKeys.SERVICES, target) ?? DEFAULT_ARRAY) as Array<AsyncLazyConstructor>,
    }
}
...
export const SyncModuleExtractor = (target: Object) => {
    return {
        ...
        services: (Reflect.getMetadata(MDKeys.SERVICES, target) ?? DEFAULT_ARRAY) as Array<SyncLazyConstructor>,
    }
}
