import { observable, action, set, computed, IComputedValue } from "mobx";
import axios, { CancelTokenSource, AxiosRequestConfig } from "axios";
import * as pathToRegexp from "path-to-regexp";
import * as  qs from "query-string";
import { DEFAULT_STRING, DEFAULT_OBJECT, DEFAULT_FUNCTION } from "client/utils/constants";
...
export default class RequestStore<D> {
    ...
    @observable private timeout: number = 60000;
    ...
    @observable private query: () => CommonMap = () => { return DEFAULT_OBJECT };
    @observable private params: () => CommonMap = () => { return DEFAULT_OBJECT };
