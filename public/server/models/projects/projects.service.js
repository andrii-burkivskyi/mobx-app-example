...
let ProjectsService = class ProjectsService {
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.projectsRepository.findOne({ id }, { relations: ["entities"] });
        });
    }
    create(input) {
        return __awaiter(this, void 0, void 0, function* () {
            const project = this.projectsRepository.create(input);
            return yield this.projectsRepository.save(project);
        });
    }
    update(input) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentProject = yield this.projectsRepository.findOne({ id: input.id });
            if (currentProject) {
                const project = this.projectsRepository.create(mergeStrategy_1.merge(currentProject, input));
                yield this.projectsRepository.save(project);
    ...
    delete(input) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.projectsRepository.delete(input.id);
            return input.id;
        });
    }
};
ProjectsService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(projects_entity_1.ProjectEntity)),
